        ...
        <>
            <div className={`color-palate ${openColorPlate ? "" : "visible-palate"}`}>
                ...
                <div className="color-palate-head">
                    <h6>Memories Maker Edu Pvt. Ltd.</h6>
                </div>
                ...
                <div className="palate-foo">
                    <span>Please visit our main website</span>
                </div>
                <Link to='https://memoriesmakeredu.com/' target='blank' className="purchase-btn">Memories Maker</Link>
            </div>
        </>
    );
};
