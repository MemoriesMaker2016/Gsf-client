            ...
            <header className={`main-header ${headerStyle ? headerStyle : ""} ${isSticky ? "fixed-header" : ""}`}>
                ...
                <div className="main-box">
                    <div className="auto-container clearfix">
                        ...
                        <Link to="/"><img className='main_logo' src="/images/logo/GPS_Logo.png" alt="image" /></Link>
                        </div>
                        </div>
                        ...
                        <div className="nav-outer clearfix">
                            ...
                            <nav className="main-menu navbar-expand-lg navbar-light">
                                ...
                                <div className=" navbar-collapse clearfix max-[989px]:hidden" id="navbarSupportedContent">
                ...
                <div className={`${openMenu ? "mobile-menu-visible" : ""}`}>
                    <div className="mobile-menu">
                        ...
                        <nav className="menu-box">
                            <div className="nav-logo"><Link to="/#"><img className='main_logo' src="/images/logo/GPS_Logo.png" alt="image" /></Link></div>
