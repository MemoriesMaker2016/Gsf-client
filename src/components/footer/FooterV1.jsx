                                ...
                                <div className="row">
                                    <div className="footer-column col-xl-7 col-lg-6 col-md-6 col-sm-12">
                                        <div className="footer-widget about-widget">
                                            <div className="logo">
                                                <Link to='/'><img src="/images/logo/GPS_Logo.png" alt="image" style={{width:'70%'}}/></Link>
                                            </div>
                                            <div className="text" style={{opacity:'0'}}>
                                                <p>We have very good strength in innovative</p>
                                            </div>
                                            ...
                                            <div className="widget-content">
                                                <ul className="contact-list">
                                                    <li>
                                                        ...
                                                        <div className="text">Mon - Fri: 09:00 - 19:30</div>
                                                    </li>
                                                    <li>
                                                        <span className="icon flaticon-phone"></span>
                                                        <div className="text"><Link to="tel:+91 9991225544">+91 99912 25544</Link> <Link to="tel:+91 8447649809">+91 84476 49809</Link></div>
                                                    </li>
                                                    <li>
                                                        <span className="icon flaticon-paper-plane"></span>
                                                        <div className="text"><Link to="mailto:contact@globalscholarsforum.com">contact@globalscholarsforum.com</Link></div>
                                                    </li>
                                                    {/* <li>
                    ...
                    <div className="auto-container">
                        <div className="inner-container clearfix">
                            <div className="copyright-text">
                                <p>&copy; Copyright {(new Date().getFullYear())} All Rights Reserved by <Link to='/' >Global Scholars Forum</Link></p>
                            </div>
                        </div>
                    </div>
                </div>
