            ...
            <footer className={`main-footer style-two ${footerStyle}`}>
                ...
                <div className="auto-container">
                    <div className="footer-content">
                            <><div className="footer-logo"><Link to="/home-5"><img className='main_logo' src="/images/logo/GPS_Logo.png" alt="image" style={{width:'50%'}} /></Link></div></>
                            
                        <ul className="footer-nav">
                            <li><Link to="/home-5">Home</Link></li>
