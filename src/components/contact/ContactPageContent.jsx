                            ...
                            <div className="inner-column">
                                ...
                                <ul className="contact-info">
                                    ...
                                    <li>
                                        ...
                                        <p><Link to="tel:+91 99912255449">+91 99912 25544</Link>, <Link to="tel:+91 8447649809">+91 84476 49809</Link></p>
                                    </li>
                                    <li>
                                        <span className="icon fa fa-envelope"></span>
                                        <p><strong>Mail Us</strong></p>
                                        <p><a href="mailto:contact@globalscholarsforum.com">contact@globalscholarsforum.com</a></p>
                                    </li>
                                    <li>
                                        <span className="icon fa fa-clock"></span>
                                        <p><strong>Opening Time</strong></p>
                                        <p>Mon - Sat: 09.00am to 19.30pm</p>
                                    </li>
                                </ul>
